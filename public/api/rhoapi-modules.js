...
(function ($, rho, rhoUtil) {
    ...
    // === Application hash keys ===
            ...
            Application.PROPERTY_APPS_BUNDLE_FOLDER = "appsBundleFolder"; 

            Application.PROPERTY_APP_BUNDLE_FOLDER = "appBundleFolder"; 

            Application.PROPERTY_APP_NAME = "appName"; 

            Application.PROPERTY_BAD_LINK_URI = "badLinkURI"; 

            Application.PROPERTY_BUNDLE_FOLDER = "bundleFolder"; 

            Application.PROPERTY_CONFIG_PATH = "configPath"; 

            Application.PROPERTY_COUNTRY = "country"; 

            Application.PROPERTY_DATABASE_BLOB_FOLDER = "databaseBlobFolder"; 

            Application.PROPERTY_DEFAULT_NATIVE_MENU = "defaultNativeMenu"; 

            Application.PROPERTY_INVALID_SECURITY_TOKEN_START_PATH = "invalidSecurityTokenStartPath"; 

            Application.PROPERTY_LOCALE = "locale"; 

            Application.PROPERTY_MODELS_MANIFEST_PATH = "modelsManifestPath"; 

            Application.PROPERTY_NATIVE_MENU = "nativeMenu"; 

            Application.PROPERTY_PUBLIC_FOLDER = "publicFolder"; 

            Application.PROPERTY_RHO_PLATFORM_VERSION = "rhoPlatformVersion"; 

            Application.PROPERTY_SECURITY_TOKEN_NOT_PASSED = "securityTokenNotPassed"; 

            Application.PROPERTY_SETTINGS_PAGE_URI = "settingsPageURI"; 

            Application.PROPERTY_SPLASH = "splash"; 

            Application.PROPERTY_START_URI = "startURI"; 

            Application.PROPERTY_TITLE = "title"; 

            Application.PROPERTY_USER_FOLDER = "userFolder"; 

            Application.PROPERTY_VERSION = "version"; 
...
(function ($, rho, rhoUtil) {
    ...
    // === Log hash keys ===
            ...
            Log.PROPERTY_DESTINATION = "destination"; 

            Log.PROPERTY_DESTINATION_URI = "destinationURI"; 

            Log.PROPERTY_EXCLUDE_CATEGORIES = "excludeCategories"; 

            Log.PROPERTY_EXCLUDE_FILTER = "excludeFilter"; 

            Log.PROPERTY_FILE_PATH = "filePath"; 

            Log.PROPERTY_FILE_SIZE = "fileSize"; 

            Log.PROPERTY_INCLUDE_CATEGORIES = "includeCategories"; 

            Log.PROPERTY_LEVEL = "level"; 

            Log.PROPERTY_MEMORY_PERIOD = "memoryPeriod"; 

            Log.PROPERTY_NET_TRACE = "netTrace"; 

            Log.PROPERTY_SKIP_POST = "skipPost"; 
...
(function ($, rho, rhoUtil) {
    ...
    // === NativeMenubar hash keys ===
    
    
            NativeMenubar.PROPERTY_DEFAULT_MAIN_MENU = "defaultMainMenu"; 

            NativeMenubar.PROPERTY_EXTRA_BUTTON = "extraButton"; 

            NativeMenubar.PROPERTY_EXTRA_MENU = "extraMenu"; 

            NativeMenubar.PROPERTY_MAIN_BUTTON = "mainButton"; 

            NativeMenubar.PROPERTY_MAIN_MENU = "mainMenu"; 
...
(function ($, rho, rhoUtil) {
    ...
    // === Network hash keys ===
            ...
            Network.PROPERTY_AUTH_PASSWORD = "authPassword"; 

            Network.PROPERTY_AUTH_TYPE = "authType"; 

            Network.PROPERTY_AUTH_USER = "authUser"; 

            Network.PROPERTY_HEADERS = "headers"; 

            Network.PROPERTY_HTTP_VERB = "httpVerb"; 

            Network.PROPERTY_RESPONSE_TIMEOUT = "responseTimeout"; 

            Network.PROPERTY_URL = "url"; 

            Network.PROPERTY_VERIFY_PEER_CERTIFICATE = "verifyPeerCertificate"; 
...
(function ($, rho, rhoUtil) {
    ...
    // === Notification constants ===
            ...
            Notification.KIND_DIALOG = 'dialog'; 
    
            Notification.KIND_NOTIFICATION = 'notification'; 
    
            Notification.KIND_NOTIFICATION_DIALOG = 'notificationDialog'; 
    
            Notification.KIND_TOAST = 'toast'; 
...
(function ($, rho, rhoUtil) {
    ...
    // === Push hash keys ===
            ...
            Push.PROPERTY_PUSH_APP_NAME = "pushAppName"; 

            Push.PROPERTY_PUSH_SERVER = "pushServer"; 

            Push.PROPERTY_TYPE = "type"; 

            Push.PROPERTY_USER_NOTIFY_MODE_DEPRECATED = "userNotifyMode"; 
...
(function ($, rho, rhoUtil) {
    ...
    // === System hash keys ===
            ...
            System.PROPERTY_APPLICATION_ICON_BADGE = "applicationIconBadge"; 

            System.PROPERTY_COUNTRY = "country"; 

            System.PROPERTY_DEVICE_NAME = "deviceName"; 

            System.PROPERTY_DEVICE_OWNER_EMAIL = "deviceOwnerEmail"; 

            System.PROPERTY_DEVICE_OWNER_NAME = "deviceOwnerName"; 

            System.PROPERTY_DEVICE_PUSH_ID = "devicePushId"; 

            System.PROPERTY_FREE_SERVER_PORT = "freeServerPort"; 

            System.PROPERTY_HAS_CALENDAR = "hasCalendar"; 

            System.PROPERTY_HAS_CAMERA = "hasCamera"; 

            System.PROPERTY_HAS_CELL_NETWORK_DEPRECATED = "hasCellNetwork"; 

            System.PROPERTY_HAS_NETWORK_DEPRECATED = "hasNetwork"; 

            System.PROPERTY_HAS_SQLITE_DEPRECATED = "hasSqlite"; 

            System.PROPERTY_HAS_TOUCHSCREEN = "hasTouchscreen"; 

            System.PROPERTY_HAS_WIFI_NETWORK_DEPRECATED = "hasWifiNetwork"; 

            System.PROPERTY_HTTP_PROXY_URI = "httpProxyURI"; 

            System.PROPERTY_IS_EMULATOR = "isEmulator"; 

            System.PROPERTY_IS_MOTOROLA_DEVICE = "isMotorolaDevice"; 

            System.PROPERTY_IS_RHO_SIMULATOR = "isRhoSimulator"; 

            System.PROPERTY_KEYBOARD_STATE = "keyboardState"; 

            System.PROPERTY_LOCALE = "locale"; 

            System.PROPERTY_LOCAL_SERVER_PORT = "localServerPort"; 

            System.PROPERTY_LOCK_WINDOW_SIZE = "lockWindowSize"; 

            System.PROPERTY_MAIN_WINDOW_CLOSED = "main_window_closed"; 

            System.PROPERTY_OEM_INFO = "oemInfo"; 

            System.PROPERTY_OS_VERSION = "osVersion"; 

            System.PROPERTY_PHONE_ID = "phoneId"; 

            System.PROPERTY_PLATFORM = "platform"; 

            System.PROPERTY_PPI_X = "ppiX"; 

            System.PROPERTY_PPI_Y = "ppiY"; 

            System.PROPERTY_REAL_SCREEN_HEIGHT = "realScreenHeight"; 

            System.PROPERTY_REAL_SCREEN_WIDTH = "realScreenWidth"; 

            System.PROPERTY_SCREEN_AUTO_ROTATE = "screenAutoRotate"; 

            System.PROPERTY_SCREEN_HEIGHT = "screenHeight"; 

            System.PROPERTY_SCREEN_ORIENTATION = "screenOrientation"; 

            System.PROPERTY_SCREEN_SLEEPING = "screenSleeping"; 

            System.PROPERTY_SCREEN_WIDTH = "screenWidth"; 

            System.PROPERTY_UUID = "uuid"; 

            System.PROPERTY_WEBVIEW_FRAMEWORK = "webviewFramework"; 
    ...
    rhoUtil.createMethodsProxy(System, [
        ...
        , { methodName: 'getStartParams', nativeName: 'getStartParams', valueCallbackIndex: 0 }
          ...
          // function(/* optional function */ oResult)
        , { methodName: 'getApplicationMessage', nativeName: 'getApplicationMessage', persistentCallbackIndex: 0, valueCallbackIndex: 2 }
    
          // function(/* optional function */ oResult)
        , { methodName: 'startApplicationMessageNotifications', nativeName: 'startApplicationMessageNotifications', persistentCallbackIndex: 0, valueCallbackIndex: 2 }
    
          // function(/* optional function */ oResult)
        , { methodName: 'stopApplicationMessageNotifications', nativeName: 'stopApplicationMessageNotifications', valueCallbackIndex: 0 }
        ...
        , { methodName: 'runApplication', nativeName: 'runApplication', valueCallbackIndex: 3 }
          ...
          // function(/* const rho::String& */ appName, /* const rho::String& */ message, /* optional function */ oResult)
        , { methodName: 'sendApplicationMessage', nativeName: 'sendApplicationMessage', valueCallbackIndex: 2 }
...
(function ($, rho, rhoUtil) {
    ...
    // === WebView hash keys ===
            ...
            WebView.PROPERTY_ACCEPT_LANGUAGE = "acceptLanguage"; 

            WebView.PROPERTY_ACTIVE_TAB = "activeTab"; 

            WebView.PROPERTY_CACHE_SIZE = "cacheSize"; 

            WebView.PROPERTY_ENABLE_CACHE = "enableCache"; 

            WebView.PROPERTY_ENABLE_PAGE_LOADING_INDICATION = "enablePageLoadingIndication"; 

            WebView.PROPERTY_ENABLE_WEB_PLUGINS = "enableWebPlugins"; 

            WebView.PROPERTY_ENABLE_ZOOM = "enableZoom"; 

            WebView.PROPERTY_FONT_FAMILY = "fontFamily"; 

            WebView.PROPERTY_FRAMEWORK = "framework"; 

            WebView.PROPERTY_FULL_SCREEN = "fullScreen"; 

            WebView.PROPERTY_NAVIGATION_TIMEOUT = "navigationTimeout"; 

            WebView.PROPERTY_SCROLL_TECHNIQUE = "scrollTechnique"; 

            WebView.PROPERTY_TEXT_ZOOM_LEVEL = "textZoomLevel"; 

            WebView.PROPERTY_USER_AGENT = "userAgent"; 

            WebView.PROPERTY_VIEWPORT_ENABLED = "viewportEnabled"; 

            WebView.PROPERTY_VIEWPORT_WIDTH = "viewportWidth"; 

            WebView.PROPERTY_ZOOM_PAGE = "zoomPage"; 
...
(function ($, rho, rhoUtil) {
    ...
    // === Sensor hash keys ===
            ...
            Sensor.PROPERTY_MINIMUM_GAP = "minimumGap"; 

            Sensor.PROPERTY_STATUS = "status"; 

            Sensor.PROPERTY_TYPE = "type"; 
...
(function ($, rho, rhoUtil) {
    ...
    // === RhoConnectClient hash keys ===
            ...
            RhoConnectClient.PROPERTY_BULKSYNC_STATE = "bulksyncState"; 

            RhoConnectClient.PROPERTY_PAGE_SIZE = "pageSize"; 

            RhoConnectClient.PROPERTY_POLL_INTERVAL = "pollInterval"; 

            RhoConnectClient.PROPERTY_SHOW_STATUS_POPUP = "showStatusPopup"; 

            RhoConnectClient.PROPERTY_SSL_VERIFY_PEER = "sslVerifyPeer"; 

            RhoConnectClient.PROPERTY_SYNC_SERVER = "syncServer"; 

            RhoConnectClient.PROPERTY_THREADED_MODE = "threadedMode"; 

            RhoConnectClient.PROPERTY_USER_NAME = "userName"; 
...
(function ($, rho, rhoUtil) {
    ...
    // === Barcode hash keys ===
            ...
            Barcode.PROPERTY_ADAPTIVE_SCANNING = "adaptiveScanning"; 

            Barcode.PROPERTY_AIM_MODE = "aimMode"; 

            Barcode.PROPERTY_AIM_TYPE = "aimType"; 

            Barcode.PROPERTY_ALL_DECODERS = "allDecoders"; 

            Barcode.PROPERTY_AUS_POSTAL = "ausPostal"; 

            Barcode.PROPERTY_AUTO_ENTER = "autoEnter"; 

            Barcode.PROPERTY_AUTO_TAB = "autoTab"; 

            Barcode.PROPERTY_AZTEC = "aztec"; 

            Barcode.PROPERTY_BARCODE_DATA_FORMAT = "barcodeDataFormat"; 

            Barcode.PROPERTY_BEAM_WIDTH = "beamWidth"; 

            Barcode.PROPERTY_BIDIRECTIONAL_REDUNDANCY = "bidirectionalRedundancy"; 

            Barcode.PROPERTY_CAN_POSTAL = "canPostal"; 

            Barcode.PROPERTY_CHINESE2OF5 = "chinese2of5"; 

            Barcode.PROPERTY_CODABAR = "codabar"; 

            Barcode.PROPERTY_CODABAR_CLSI_EDITING = "codabarClsiEditing"; 

            Barcode.PROPERTY_CODABAR_MAX_LENGTH = "codabarMaxLength"; 

            Barcode.PROPERTY_CODABAR_MIN_LENGTH = "codabarMinLength"; 

            Barcode.PROPERTY_CODABAR_NOTIS_EDITING = "codabarNotisEditing"; 

            Barcode.PROPERTY_CODABAR_REDUNDANCY = "codabarRedundancy"; 

            Barcode.PROPERTY_CODE11 = "code11"; 

            Barcode.PROPERTY_CODE11CHECK_DIGIT_COUNT = "code11checkDigitCount"; 

            Barcode.PROPERTY_CODE11MAX_LENGTH = "code11maxLength"; 

            Barcode.PROPERTY_CODE11MIN_LENGTH = "code11minLength"; 

            Barcode.PROPERTY_CODE11REDUNDANCY = "code11redundancy"; 

            Barcode.PROPERTY_CODE11REPORT_CHECK_DIGIT = "code11reportCheckDigit"; 

            Barcode.PROPERTY_CODE128 = "code128"; 

            Barcode.PROPERTY_CODE128CHECK_IS_BT_TABLE = "code128checkIsBtTable"; 

            Barcode.PROPERTY_CODE128EAN128 = "code128ean128"; 

            Barcode.PROPERTY_CODE128ISBT128 = "code128isbt128"; 

            Barcode.PROPERTY_CODE128ISBT128_CONCAT_MODE = "code128isbt128ConcatMode"; 

            Barcode.PROPERTY_CODE128MAX_LENGTH = "code128maxLength"; 

            Barcode.PROPERTY_CODE128MIN_LENGTH = "code128minLength"; 

            Barcode.PROPERTY_CODE128OTHER128 = "code128other128"; 

            Barcode.PROPERTY_CODE128REDUNDANCY = "code128redundancy"; 

            Barcode.PROPERTY_CODE128SECURITY_LEVEL = "code128securityLevel"; 

            Barcode.PROPERTY_CODE39 = "code39"; 

            Barcode.PROPERTY_CODE39CODE32_PREFIX = "code39code32Prefix"; 

            Barcode.PROPERTY_CODE39CONVERT_TO_CODE32 = "code39convertToCode32"; 

            Barcode.PROPERTY_CODE39FULL_ASCII = "code39fullAscii"; 

            Barcode.PROPERTY_CODE39MAX_LENGTH = "code39maxLength"; 

            Barcode.PROPERTY_CODE39MIN_LENGTH = "code39minLength"; 

            Barcode.PROPERTY_CODE39REDUNDANCY = "code39redundancy"; 

            Barcode.PROPERTY_CODE39REPORT_CHECK_DIGIT = "code39reportCheckDigit"; 

            Barcode.PROPERTY_CODE39SECURITY_LEVEL = "code39securityLevel"; 

            Barcode.PROPERTY_CODE39VERIFY_CHECK_DIGIT = "code39verifyCheckDigit"; 

            Barcode.PROPERTY_CODE93 = "code93"; 

            Barcode.PROPERTY_CODE93MAX_LENGTH = "code93maxLength"; 

            Barcode.PROPERTY_CODE93MIN_LENGTH = "code93minLength"; 

            Barcode.PROPERTY_CODE93REDUNDANCY = "code93redundancy"; 

            Barcode.PROPERTY_COMPOSITE_AB = "compositeAb"; 

            Barcode.PROPERTY_COMPOSITE_AB_UCC_LINK_MODE = "compositeAbUccLinkMode"; 

            Barcode.PROPERTY_COMPOSITE_AB_USE_UPC_PREAMBLE_CHECK_DIGIT_RULES = "compositeAbUseUpcPreambleCheckDigitRules"; 

            Barcode.PROPERTY_COMPOSITE_C = "compositeC"; 

            Barcode.PROPERTY_CONNECTION_IDLE_TIMEOUT = "connectionIdleTimeout"; 

            Barcode.PROPERTY_D2OF5 = "d2of5"; 

            Barcode.PROPERTY_D2OF5MAX_LENGTH = "d2of5maxLength"; 

            Barcode.PROPERTY_D2OF5MIN_LENGTH = "d2of5minLength"; 

            Barcode.PROPERTY_D2OF5REDUNDANCY = "d2of5redundancy"; 

            Barcode.PROPERTY_DATAMATRIX = "datamatrix"; 

            Barcode.PROPERTY_DATA_BUFFER_SIZE = "dataBufferSize"; 

            Barcode.PROPERTY_DBP_MODE = "dbpMode"; 

            Barcode.PROPERTY_DECODE_DURATION = "decodeDuration"; 

            Barcode.PROPERTY_DECODE_FREQUENCY = "decodeFrequency"; 

            Barcode.PROPERTY_DECODE_SOUND = "decodeSound"; 

            Barcode.PROPERTY_DECODE_VOLUME = "decodeVolume"; 

            Barcode.PROPERTY_DIFFERENT_SYMBOL_TIMEOUT = "differentSymbolTimeout"; 

            Barcode.PROPERTY_DISCONNECT_BT_ON_DISABLE = "disconnectBtOnDisable"; 

            Barcode.PROPERTY_DISPLAY_BT_ADDRESS_BARCODE_ON_ENABLE = "displayBtAddressBarcodeOnEnable"; 

            Barcode.PROPERTY_DPM_MODE = "dpmMode"; 

            Barcode.PROPERTY_DUTCH_POSTAL = "dutchPostal"; 

            Barcode.PROPERTY_EAN13 = "ean13"; 

            Barcode.PROPERTY_EAN8 = "ean8"; 

            Barcode.PROPERTY_EAN8CONVERT_TO_EAN13 = "ean8convertToEan13"; 

            Barcode.PROPERTY_ENABLE_TIMEOUT = "enableTimeout"; 

            Barcode.PROPERTY_FOCUS_MODE = "focusMode"; 

            Barcode.PROPERTY_FRIENDLY_NAME = "friendlyName"; 

            Barcode.PROPERTY_GS1DATA_BAR = "gs1dataBar"; 

            Barcode.PROPERTY_GS1DATA_BAR_EXPANDED = "gs1dataBarExpanded"; 

            Barcode.PROPERTY_GS1DATA_BAR_LIMITED = "gs1dataBarLimited"; 

            Barcode.PROPERTY_HAPTIC_FEEDBACK = "hapticFeedback"; 

            Barcode.PROPERTY_I2OF5 = "i2of5"; 

            Barcode.PROPERTY_I2OF5CONVERT_TO_EAN13 = "i2of5convertToEan13"; 

            Barcode.PROPERTY_I2OF5MAX_LENGTH = "i2of5maxLength"; 

            Barcode.PROPERTY_I2OF5MIN_LENGTH = "i2of5minLength"; 

            Barcode.PROPERTY_I2OF5REDUNDANCY = "i2of5redundancy"; 

            Barcode.PROPERTY_I2OF5REPORT_CHECK_DIGIT = "i2of5reportCheckDigit"; 

            Barcode.PROPERTY_I2OF5VERIFY_CHECK_DIGIT = "i2of5verifyCheckDigit"; 

            Barcode.PROPERTY_ILLUMINATION_MODE = "illuminationMode"; 

            Barcode.PROPERTY_INVALID_DECODE_FREQUENCY = "invalidDecodeFrequency"; 

            Barcode.PROPERTY_INVALID_DECODE_SOUND = "invalidDecodeSound"; 

            Barcode.PROPERTY_INVERSE1D_MODE = "inverse1dMode"; 

            Barcode.PROPERTY_JAP_POSTAL = "japPostal"; 

            Barcode.PROPERTY_KLASSE_EINS = "klasseEins"; 

            Barcode.PROPERTY_KOREAN3OF5 = "korean3of5"; 

            Barcode.PROPERTY_KOREAN3OF5MAX_LENGTH = "korean3of5maxLength"; 

            Barcode.PROPERTY_KOREAN3OF5MIN_LENGTH = "korean3of5minLength"; 

            Barcode.PROPERTY_KOREAN3OF5REDUNDANCY = "korean3of5redundancy"; 

            Barcode.PROPERTY_LCD_MODE = "lcdMode"; 

            Barcode.PROPERTY_LINEAR_SECURITY_LEVEL = "linearSecurityLevel"; 

            Barcode.PROPERTY_LOW_BATTERY_SCAN = "lowBatteryScan"; 

            Barcode.PROPERTY_MACRO_MICRO_PDF = "macroMicroPdf"; 

            Barcode.PROPERTY_MACRO_MICRO_PDF_BUFFER_LABELS = "macroMicroPdfBufferLabels"; 

            Barcode.PROPERTY_MACRO_MICRO_PDF_CONVERT_TO_MICRO_PDF = "macroMicroPdfConvertToMicroPdf"; 

            Barcode.PROPERTY_MACRO_MICRO_PDF_EXCLUSIVE = "macroMicroPdfExclusive"; 

            Barcode.PROPERTY_MACRO_MICRO_PDF_REPORT_APPEND_INFO = "macroMicroPdfReportAppendInfo"; 

            Barcode.PROPERTY_MACRO_PDF = "macroPdf"; 

            Barcode.PROPERTY_MACRO_PDF_BUFFER_LABELS = "macroPdfBufferLabels"; 

            Barcode.PROPERTY_MACRO_PDF_CONVERT_TO_PDF417 = "macroPdfConvertToPdf417"; 

            Barcode.PROPERTY_MACRO_PDF_EXCLUSIVE = "macroPdfExclusive"; 

            Barcode.PROPERTY_MATRIX2OF5 = "matrix2of5"; 

            Barcode.PROPERTY_MATRIX2OF5MAX_LENGTH = "matrix2of5maxLength"; 

            Barcode.PROPERTY_MATRIX2OF5MIN_LENGTH = "matrix2of5minLength"; 

            Barcode.PROPERTY_MATRIX2OF5REPORT_CHECK_DIGIT = "matrix2of5reportCheckDigit"; 

            Barcode.PROPERTY_MATRIX2OF5VERIFY_CHECK_DIGIT = "matrix2of5verifyCheckDigit"; 

            Barcode.PROPERTY_MAXI_CODE = "maxiCode"; 

            Barcode.PROPERTY_MICRO_PDF = "microPdf"; 

            Barcode.PROPERTY_MICRO_QR = "microQr"; 

            Barcode.PROPERTY_MSI = "msi"; 

            Barcode.PROPERTY_MSI_CHECK_DIGITS = "msiCheckDigits"; 

            Barcode.PROPERTY_MSI_CHECK_DIGIT_SCHEME = "msiCheckDigitScheme"; 

            Barcode.PROPERTY_MSI_MAX_LENGTH = "msiMaxLength"; 

            Barcode.PROPERTY_MSI_MIN_LENGTH = "msiMinLength"; 

            Barcode.PROPERTY_MSI_REDUNDANCY = "msiRedundancy"; 

            Barcode.PROPERTY_MSI_REPORT_CHECK_DIGIT = "msiReportCheckDigit"; 

            Barcode.PROPERTY_PDF417 = "pdf417"; 

            Barcode.PROPERTY_PICKLIST_MODE = "picklistMode"; 

            Barcode.PROPERTY_POOR_QUALITY1D_MODE = "poorQuality1dMode"; 

            Barcode.PROPERTY_QR_CODE = "qrCode"; 

            Barcode.PROPERTY_RASTER_HEIGHT = "rasterHeight"; 

            Barcode.PROPERTY_RASTER_MODE = "rasterMode"; 

            Barcode.PROPERTY_RSM_BATTERY_CAPACITY = "rsmBatteryCapacity"; 

            Barcode.PROPERTY_RSM_BATTERY_ID = "rsmBatteryId"; 

            Barcode.PROPERTY_RSM_BATTERY_STATUS = "rsmBatteryStatus"; 

            Barcode.PROPERTY_RSM_BLUETOOTH_ADDRESS = "rsmBluetoothAddress"; 

            Barcode.PROPERTY_RSM_BLUETOOTH_AUTHENTICATION = "rsmBluetoothAuthentication"; 

            Barcode.PROPERTY_RSM_BLUETOOTH_AUTO_RECONNECT = "rsmBluetoothAutoReconnect"; 

            Barcode.PROPERTY_RSM_BLUETOOTH_BEEP_ON_RECONNECT_ATTEMPT = "rsmBluetoothBeepOnReconnectAttempt"; 

            Barcode.PROPERTY_RSM_BLUETOOTH_ENCRYPTION = "rsmBluetoothEncryption"; 

            Barcode.PROPERTY_RSM_BLUETOOTH_FRIENDLY_NAME = "rsmBluetoothFriendlyName"; 

            Barcode.PROPERTY_RSM_BLUETOOTH_HID_AUTO_RECONNECT = "rsmBluetoothHidAutoReconnect"; 

            Barcode.PROPERTY_RSM_BLUETOOTH_INQUIRY_MODE = "rsmBluetoothInquiryMode"; 

            Barcode.PROPERTY_RSM_BLUETOOTH_PIN_CODE = "rsmBluetoothPinCode"; 

            Barcode.PROPERTY_RSM_BLUETOOTH_PIN_CODE_TYPE = "rsmBluetoothPinCodeType"; 

            Barcode.PROPERTY_RSM_BLUETOOTH_RECONNECTION_ATTEMPTS = "rsmBluetoothReconnectionAttempts"; 

            Barcode.PROPERTY_RSM_DATE_OF_MANUFACTURE = "rsmDateOfManufacture"; 

            Barcode.PROPERTY_RSM_DATE_OF_SERVICE = "rsmDateOfService"; 

            Barcode.PROPERTY_RSM_DECODE_FEEDBACK = "rsmDecodeFeedback"; 

            Barcode.PROPERTY_RSM_DEVICE_CLASS = "rsmDeviceClass"; 

            Barcode.PROPERTY_RSM_FIRMWARE_VERSION = "rsmFirmwareVersion"; 

            Barcode.PROPERTY_RSM_FORCE_SAVE_PAIRING_BARCODE = "rsmForceSavePairingBarcode"; 

            Barcode.PROPERTY_RSM_GOOD_SCANS_DELAY = "rsmGoodScansDelay"; 

            Barcode.PROPERTY_RSM_IGNORE_CODE128_USPS = "rsmIgnoreCode128Usps"; 

            Barcode.PROPERTY_RSM_LOW_BATTERY_INDICATION = "rsmLowBatteryIndication"; 

            Barcode.PROPERTY_RSM_LOW_BATTERY_INDICATION_CYCLE = "rsmLowBatteryIndicationCycle"; 

            Barcode.PROPERTY_RSM_MEMS = "rsmMems"; 

            Barcode.PROPERTY_RSM_MODEL_NUMBER = "rsmModelNumber"; 

            Barcode.PROPERTY_RSM_PAGING_BEEP_SEQUENCE = "rsmPagingBeepSequence"; 

            Barcode.PROPERTY_RSM_PAGING_ENABLE = "rsmPagingEnable"; 

            Barcode.PROPERTY_RSM_PROXIMITY_CONTINUOUS = "rsmProximityContinuous"; 

            Barcode.PROPERTY_RSM_PROXIMITY_DISTANCE = "rsmProximityDistance"; 

            Barcode.PROPERTY_RSM_PROXIMITY_ENABLE = "rsmProximityEnable"; 

            Barcode.PROPERTY_RSM_SCAN_LINE_WIDTH = "rsmScanLineWidth"; 

            Barcode.PROPERTY_RSM_SCAN_TRIGGER_WAKEUP = "rsmScanTriggerWakeup"; 

            Barcode.PROPERTY_RSM_SERIAL_NUMBER = "rsmSerialNumber"; 

            Barcode.PROPERTY_SAME_SYMBOL_TIMEOUT = "sameSymbolTimeout"; 

            Barcode.PROPERTY_SCANNER_TYPE = "scannerType"; 

            Barcode.PROPERTY_SCAN_TIMEOUT = "scanTimeout"; 

            Barcode.PROPERTY_SIGNATURE = "signature"; 

            Barcode.PROPERTY_SIGNATURE_IMAGE_HEIGHT = "signatureImageHeight"; 

            Barcode.PROPERTY_SIGNATURE_IMAGE_QUALITY = "signatureImageQuality"; 

            Barcode.PROPERTY_SIGNATURE_IMAGE_WIDTH = "signatureImageWidth"; 

            Barcode.PROPERTY_TIMED_AIM_DURATION = "timedAimDuration"; 

            Barcode.PROPERTY_TLC39 = "tlc39"; 

            Barcode.PROPERTY_TRIGGER_CONNECTED = "triggerConnected"; 

            Barcode.PROPERTY_TRIOPTIC39 = "trioptic39"; 

            Barcode.PROPERTY_TRIOPTIC39_REDUNDANCY = "trioptic39Redundancy"; 

            Barcode.PROPERTY_UK_POSTAL = "ukPostal"; 

            Barcode.PROPERTY_UK_POSTAL_REPORT_CHECK_DIGIT = "ukPostalReportCheckDigit"; 

            Barcode.PROPERTY_UPCA = "upca"; 

            Barcode.PROPERTY_UPCA_PREAMBLE = "upcaPreamble"; 

            Barcode.PROPERTY_UPCA_REPORT_CHECK_DIGIT = "upcaReportCheckDigit"; 

            Barcode.PROPERTY_UPCE0 = "upce0"; 

            Barcode.PROPERTY_UPCE0CONVERT_TO_UPCA = "upce0convertToUpca"; 

            Barcode.PROPERTY_UPCE0PREAMBLE = "upce0preamble"; 

            Barcode.PROPERTY_UPCE0REPORT_CHECK_DIGIT = "upce0reportCheckDigit"; 

            Barcode.PROPERTY_UPCE1 = "upce1"; 

            Barcode.PROPERTY_UPCE1CONVERT_TO_UPCA = "upce1convertToUpca"; 

            Barcode.PROPERTY_UPCE1PREAMBLE = "upce1preamble"; 

            Barcode.PROPERTY_UPCE1REPORT_CHECK_DIGIT = "upce1reportCheckDigit"; 

            Barcode.PROPERTY_UPC_EAN_BOOKLAND = "upcEanBookland"; 

            Barcode.PROPERTY_UPC_EAN_BOOKLAND_FORMAT = "upcEanBooklandFormat"; 

            Barcode.PROPERTY_UPC_EAN_CONVERT_GS1DATA_BAR_TO_UPC_EAN = "upcEanConvertGs1dataBarToUpcEan"; 

            Barcode.PROPERTY_UPC_EAN_COUPON = "upcEanCoupon"; 

            Barcode.PROPERTY_UPC_EAN_LINEAR_DECODE = "upcEanLinearDecode"; 

            Barcode.PROPERTY_UPC_EAN_RANDOM_WEIGHT_CHECK_DIGIT = "upcEanRandomWeightCheckDigit"; 

            Barcode.PROPERTY_UPC_EAN_RETRY_COUNT = "upcEanRetryCount"; 

            Barcode.PROPERTY_UPC_EAN_SECURITY_LEVEL = "upcEanSecurityLevel"; 

            Barcode.PROPERTY_UPC_EAN_SUPPLEMENTAL2 = "upcEanSupplemental2"; 

            Barcode.PROPERTY_UPC_EAN_SUPPLEMENTAL5 = "upcEanSupplemental5"; 

            Barcode.PROPERTY_UPC_EAN_SUPPLEMENTAL_MODE = "upcEanSupplementalMode"; 

            Barcode.PROPERTY_US4STATE = "us4state"; 

            Barcode.PROPERTY_US4STATE_FICS = "us4stateFics"; 

            Barcode.PROPERTY_US_PLANET = "usPlanet"; 

            Barcode.PROPERTY_US_PLANET_REPORT_CHECK_DIGIT = "usPlanetReportCheckDigit"; 

            Barcode.PROPERTY_US_POST_NET = "usPostNet"; 

            Barcode.PROPERTY_US_POST_NET_REPORT_CHECK_DIGIT = "usPostNetReportCheckDigit"; 

            Barcode.PROPERTY_VIEWFINDER_FEEDBACK = "viewfinderFeedback"; 

            Barcode.PROPERTY_VIEWFINDER_FEEDBACK_TIME = "viewfinderFeedbackTime"; 

            Barcode.PROPERTY_VIEWFINDER_HEIGHT = "viewfinderHeight"; 

            Barcode.PROPERTY_VIEWFINDER_MODE = "viewfinderMode"; 

            Barcode.PROPERTY_VIEWFINDER_WIDTH = "viewfinderWidth"; 

            Barcode.PROPERTY_VIEWFINDER_X = "viewfinderX"; 

            Barcode.PROPERTY_VIEWFINDER_Y = "viewfinderY"; 

            Barcode.PROPERTY_WEBCODE = "webcode"; 

            Barcode.PROPERTY_WEBCODE_DECODE_GT_SUBTYPE = "webcodeDecodeGtSubtype"; 
...
(function ($, rho, rhoUtil) {
    ...
    // === CardReader hash keys ===
            ...
            CardReader.PROPERTY_AUTO_ENTER = "autoEnter"; 

            CardReader.PROPERTY_AUTO_TAB = "autoTab"; 

            CardReader.PROPERTY_MODULE_NAME_DEPRECATED = "moduleName"; 

            CardReader.PROPERTY_PAN_DATA = "panData"; 

            CardReader.PROPERTY_PIN_ENTRY = "pinEntry"; 

            CardReader.PROPERTY_PIN_TIMEOUT = "pinTimeout"; 
...
(function ($, rho, rhoUtil) {
    ...
    // === Battery hash keys ===
            ...
            Battery.PROPERTY_REFRESH_INTERVAL = "refreshInterval"; 
...
(function ($, rho, rhoUtil) {
    ...
    // === SignalIndicators hash keys ===
            ...
            SignalIndicators.PROPERTY_REFRESH_INTERVAL = "refreshInterval"; 
...
(function ($, rho, rhoUtil) {
    ...
    // === KeyCapture hash keys ===
            ...
            KeyCapture.PROPERTY_HOME_KEY_VALUE = "homeKeyValue"; 
